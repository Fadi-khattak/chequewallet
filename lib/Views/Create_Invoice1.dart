    ...
    return GetX<InvoiceController>(
      builder: (_) {
        return _.isLoading.isTrue ? LoadingScreen() : Scaffold(
          ...
          bottomNavigationBar:BottomButtons(leftTitle: "Back",leftIcon: Icons.keyboard_arrow_left,onBack: (){},rightTitle:"Next",rightIcon: Icons.keyboard_arrow_right,onNext: ()async{
