    ...
    return GetX<SignupController>(
      builder: (_) {
        ...
        return _.isLoading.isTrue ? LoadingScreen() : Scaffold(
          ...
          SingleChildScrollView(
            child: Column(
              children: [
                ...
                Row(
                  children: [
                    Expanded(child: obj1.TextField1("FIRST NAME", "Enter YOur First Name", 5, 5, firstname)),

                    Expanded(child: obj1.TextField1("LAST NAME", "Enter YOur Last Name", 5, 5, lastname)),
                  ],
                ),
                SizedBox(height: 20),
                   obj1.TextField1("USERNAME", "Enter User Name", 5, 5, username),
          ...
          bottomNavigationBar: BottomButtons(onBack: (){}, onNext:()async{
            ...
            else if(transaction_password.text!=re_enter_transaction_password)
              ShowErrorAlert("transaction pass does not matched");
            else if(password.text != re_enter_password.text)
              ShowErrorAlert("password doesnot matched");
