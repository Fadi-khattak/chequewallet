...
class PayeeCreated extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar:BottomButtons(leftTitle: "Back",leftIcon: Icons.keyboard_arrow_left,onBack: (){},rightTitle:"Done",rightIcon: Icons.keyboard_arrow_right,onNext: (){}),
    );
  }
