...
class AddBankAccountController extends GetxController
{
      ...
      })async
  {
    try{
      ...
      String url="https://tls.bankaccountchecker.com/listener.php?key=c284939c107fb03fac17aa15ae6bed4b&password=Chequewallet1@&output=json&type=uk_bankaccount&sortcode=${sortCode}&bankaccount=${accountNumber}";
